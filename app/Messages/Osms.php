...
class Osms extends Model
{
     ...
     * @var string
     */
    protected $clientId = 'Op1n8MremtSsMhzpylsZIt8A1u4Tw6mp';
     ...
     * @var string
     */
    protected $clientSecret = 'O4qVPYGOFNPzVCz8';
    ...
    {
        $url = self::BASE_URL . '/sms/admin/v3/statistics';
    ...
    {
        $url = self::BASE_URL . '/sms/admin/v3/contracts';
    ...
    {
        $url = self::BASE_URL . '/sms/admin/v3/purchaseorders';
